...
export class CoinService {
  ...
  apiSubject: Subject<string>; //notifies it’s observers with a string message based on api actions
  fiatSubject: Subject<string>; //notifies it’s observers about the value of the selected fiat currency when it is updated.
